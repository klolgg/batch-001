package site.klol.batch001.match.entity;
...
public class MatchHistory extends BaseEntity {
    ...
    @Column(name = "is_updated", nullable = false, length = 1)
    @Enumerated(EnumType.STRING)
    private YNFlag isUpdated;

    public static MatchHistory of(Summoner summoner, String matchId, YNFlag isUpdated) {
        return new MatchHistory(null, summoner, matchId, isUpdated);
    }
}
